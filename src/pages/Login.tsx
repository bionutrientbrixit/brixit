            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="mt-1 relative">
                  ...
                  <Input id="email" name="email" type="email" autoComplete="email" required value={email} onChange={handleEmailChange} className="pl-10" placeholder="you@example.com" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mt-1 relative">
                  ...
                  <Input id="password" name="password" type={showPassword ? 'text' : 'password'} autoComplete="current-password" required value={password} onChange={handlePasswordChange} className="pl-10 pr-10" placeholder="••••••••" />
              ...
              <Button type="submit" disabled={isLoading || attemptCount >= 5} className="w-full bg-green-600 hover:bg-green-700">
